...
const clients = [
  {
    ...
    description: "IT infrastructure modernization and secure data management systems.",
  },
  {
    icon: Building2,
    name: "National Health Agency",
    description: "Integrated health information systems and network deployment.",
  },
  {
    icon: Scale,
    name: "Department of Justice",
    description: "Case management systems and cybersecurity implementation.",
  },
  {
    icon: Building,
    name: "Public Works Ministry",
    description: "Smart building systems and project management platforms.",
  },
  {
    icon: Briefcase,
    name: "Regional Planning Board",
    description: "GIS-based planning tools and data analytics dashboards.",
  },
  {
    icon: Globe,
    name: "Foreign Affairs Office",
    description: "Secure communication systems and cloud infrastructure.",
  },
]
      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="mb-16 text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl leading-relaxed text-muted-foreground">
            We are proud to partner with government agencies at every level,
            delivering solutions that drive efficiency and public value.
          </p>
        </div>
